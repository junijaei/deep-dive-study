...
스터디 문제가 있을 때만. → [GENERATION_RULES.md §4](./GENERATION_RULES.md#4-문제-모음-파일-규칙-chapterschnNquestionsmd)

- `chapters/chNN/questions.md` 생성

### 4. 주차 인덱스 파일 생성/수정

신규 주차면 생성, 기존 주차면 수정. → [GENERATION_RULES.md §3](./GENERATION_RULES.md#3-주차-인덱스-파일-생성-규칙-weekweekxxmd)

- `week/weekXX.md` 생성 또는 수정

### 5. README.md 업데이트

4개 영역 전부 갱신. → [README_UPDATE_RULES.md](./README_UPDATE_RULES.md)
...
[ ] README.md — Progress 테이블 링크 + ✅ 추가
[ ] README.md — 주차별 진행 현황 테이블 갱신
