...
| `week/weekXX.md` → 토론 섹션 | 주제별 토론 내용    | 스터디 중 나온 토론 내용 정리 |
...
| 챕터                              | 제목                                                 | 완료 |
| --------------------------------- | ---------------------------------------------------- | :--: |
| [ch01](./chapters/ch01/README.md) | 프로그래밍                                           |  ✅  |
| [ch02](./chapters/ch02/README.md) | 자바스크립트란?                                      |  ✅  |
| ch03                              | 자바스크립트 개발 환경과 실행 방법                   |  ✅  |
| [ch04](./chapters/ch04/README.md) | 변수                                                 |  ✅  |
| ch05                              | 표현식과 문                                          |  ✅  |
| ch06                              | 데이터 타입                                          |  ✅  |
| ch07                              | 연산자                                               |  ✅  |
| ch08                              | 제어문                                               |  ✅  |
| [ch09](./chapters/ch09/README.md) | 타입 변환과 단축 평가                                |  ✅  |
| [ch10](./chapters/ch10/README.md) | 객체 리터럴                                          |  ✅  |
| [ch11](./chapters/ch11/README.md) | 원시 값과 객체의 비교                                |  ✅  |
| [ch12](./chapters/ch12/README.md) | 함수                                                 |  ✅  |
| ch13                              | 스코프                                               |      |
| ch14                              | 전역 변수의 문제점                                   |      |
| ch15                              | let, const 키워드와 블록 레벨 스코프                 |      |
| ch16                              | 프로퍼티 어트리뷰트                                  |      |
| [ch17](./chapters/ch17/README.md) | 생성자 함수에 의한 객체 생성                         |  ✅  |
| [ch18](./chapters/ch18/README.md) | 함수와 일급 객체                                     |  ✅  |
| [ch19](./chapters/ch19/README.md) | 프로토타입                                           |  ✅  |
| [ch20](./chapters/ch20/README.md) | strict mode                                          |  ✅  |
| [ch21](./chapters/ch21/README.md) | 빌트인 객체                                          |  ✅  |
| [ch22](./chapters/ch22/README.md) | this                                                 |  ✅  |
| ch23                              | 실행 컨텍스트                                        |      |
| ch24                              | 클로저                                               |      |
| ch25                              | 클래스                                               |      |
| ch26                              | ES6 함수의 추가 기능                                 |      |
...
| 주차                        | 진행 범위   | 정리 챕터                    |
| --------------------------- | ----------- | ---------------------------- |
| [Week 01](./week/week01.md) | ch01 ~ ch10 | ch01, ch02, ch04, ch09, ch10 |
| [Week 02](./week/week02.md) | ch11 ~ ch16 | ch11, ch12                   |
| [Week 03](./week/week03.md) | ch17 ~ ch19 | ch17, ch18, ch19             |
| [Week 04](./week/week04.md) | ch20 ~ ch22 | ch20, ch21, ch22             |
